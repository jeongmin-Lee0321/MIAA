...
//            System.out.println("total : "+abdmPublic.getTotalCount());
    ...
    public static AbdmPublic abandonmentPublic(AnimalSearchDto dto,int pageno) {
        ...
        try {
            ...
            urlBuilder.append("&" + URLEncoder.encode("endde","UTF-8") + "=" + URLEncoder.encode(dto.getSearch_str_date(), "UTF-8")); /*유기날짜(검색 종료일) (YYYYMMDD)*/
            urlBuilder.append("&" + URLEncoder.encode("upkind", "UTF-8") + "=" + URLEncoder.encode(dto.getSearch_str_date(), "UTF-8")); /*축종코드 (개 : 417000, 고양이 : 422400, 기타 : 429900)*/
            urlBuilder.append("&" + URLEncoder.encode("kind","UTF-8") + "=" + URLEncoder.encode(dto.getSearch_str_date(), "UTF-8")); /*품종코드 (품종 조회 OPEN API 참조)*/
            urlBuilder.append("&" + URLEncoder.encode("upr_cd","UTF-8") + "=" + URLEncoder.encode(dto.getSearch_str_date(), "UTF-8")); /*시도코드 (시도 조회 OPEN API 참조)*/
            urlBuilder.append("&" + URLEncoder.encode("org_cd","UTF-8") + "=" + URLEncoder.encode(dto.getSearch_str_date(), "UTF-8")); /*시군구코드 (시군구 조회 OPEN API 참조)*/
            urlBuilder.append("&" + URLEncoder.encode("care_reg_no","UTF-8") + "=" + URLEncoder.encode(dto.getSearch_str_date(), "UTF-8")); /*보호소번호 (보호소 조회 OPEN API 참조)*/
