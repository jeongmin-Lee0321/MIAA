...
<body>
	<div class="main-body">
		<!-- main -->
		<!-- 원진호_0408_버튼&검색창 추가.  -->
		<div class="page_root">내정보 > 내칭 알림 목록 > 매칭 알람(물건)</div>
		<div class="border_01">
			<div class="btn-set">
				<button class="view_all_btn"
					onclick="location.href='mypage_matching_alarm_list_page'">View
					all</button>
				<button class="item_btn" onclick="location.href='mypage_matching_alarm_item_list_page'">물건</button>
				<button class="ani_btn" onclick="location.href='mypage_matching_alarm_ani_list_page'">동물</button>
