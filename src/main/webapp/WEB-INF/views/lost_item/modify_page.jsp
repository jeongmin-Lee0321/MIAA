  ...
  <div class="main-container">
    ...
    <div class="main-contents">
      <ul class="top-btns">
        ...
        <li><button type="button" onclick="location.href='lost_item_detail_page?total_id=${dto.total_id }';">취소하기</button></li>
      </ul>
      <div class="essential">
        ...
        <div class="table-container">
          ...
          <div class="table">
            <div class="table-row">
              ...
              <div class="row-content"><input type="tel" name="tel" id="tel" value="${userTels[0]}">-<input type="tel" name="tel"
                  id="tel" value="${userTels[1]}">-<input type="tel" name="tel" id="tel" value="${userTels[2]}"></div>
            </div>
            <div class="table-row">
        ...
        <div class="table-container">
          ...
          <div class="table">
            <div class="table-row">
              ...
              <div class="row-content"><input type="date" name="lostday" id="lostday" value="${dto.lostday }"></div>
            </div>
            <div class="table-row">
        ...
        <div class="table-container">
          ...
          <div class="table">
            ...
            <div class="table-row">
              ...
              <div class="row-content"><input type="text" name="itemname" id="itemname" value="${dto.item_name }"></div>
            </div>
            <div class="table-row">
              ...
              <div class="row-content">
                <select name="itemkind1" id="itemkind1"
								...
								<option value="${dto.upkind }">${dto.upkind }</option>
								...
								id="itemkind2">
								<option value="${dto.upr_cd }">${dto.upr_cd }</option>
							</select>
              </div>
            </div>
              ...
              <div class="table-row">
                ...
                <div class="row-content">
                  <select name="colorCd" id="colorCd">
                    <option value="${dto.colorcd }">${dto.colorcd }</option>
            ...
            <div class="table-row">
              ...
              <div class="row-content" id="textarea-content">
                <!-- 텍스트제한 표시 추가 필요 -->
                <textarea name="sepcialMark" id="sepcialMark" maxlength="300" placeholder="${dto.sepcialmark }"></textarea>
              </div>
            </div>
            <!-- 파일형식 제한 필요 -->
            <div class="table-row">
