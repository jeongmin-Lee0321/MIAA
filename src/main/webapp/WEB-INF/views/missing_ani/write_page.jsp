		...
		<div class="main-selection">
			...
			<div class="main-selection-flex">
				<div class="main-selection-ex">
					...
					<div class="describe">실종된 동물을 등록하시면 내정보 알림게시판에서 보호동물에 대한 정보를 받아보실 수 있습니다.</div>
				</div>
			</div>
		</div>
		...
		<form action="missing_ani_write" method="post"
			...
			<div class="main-contents">
				<ul class="top-btns">
					...
					<li><button type="button" onclick="location.href='missing_ani_search_page';" style="cursor: pointer;">취소하기</button></li>
				</ul>
				<div class="essential">
				...
				<div class="table-container">
					<div class="table-title">
						<img src="resources/img/clipboard.png" alt=""><span>보호자 정보</span>
					</div>
					<div class="table">
						<div class="table-row">
							<div class="row-title">
						...
						<div class="table-row">
							...
							<div class="row-content">
								<div class="radio-container">
									<input type="radio" name="openclose" id="openclose" value="true"><span>공개</span>
								</div>
								<div class="radio-container">
									<input type="radio" name="openclose" id="openclose" value="false" checked><span>비공개</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="table-container">
					<div class="table-title">
						<img src="resources/img/clipboard.png" alt=""><span>실종일시 및 장소</span>
					</div>
					<div class="table">
						<div class="table-row">
							<div class="row-title">
				...
				<div class="table-container">
					<div class="table-title">
						<img src="resources/img/clipboard.png" alt=""><span>실종동물 정보</span>
					</div>
					<div class="table">
						...
						<div class="table-row">
							...
							<div class="row-content">
								<select name="animalkind1" id="animalkind1"
									...
									<option value="PRI000">강아지</option>
									<option value="PRJ000">고양이</option>
									<option value="PRH000">기타</option>
